...
| 5 | yes | happened (journal) | One record-write stall (T3 feature-implementer, stopped pre-record-write); single SendMessage resume recovered it — 1 of 7 dispatched slots, within the ~1-in-3 class. Filled early — observed live. |
