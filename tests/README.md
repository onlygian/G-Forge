...
numbers rather than pointing at a directory: **23 suites** — pinned by
...
`test-telemetry-contract.sh` landed 2026-08-29) — carrying
**645 assertions** (attested 2026-08-29, summed independently from the run's
